...
import (
	"fmt"
	//"fmt"
	"github.com/learn-go/sqlserver2kafka/models"
	"github.com/learn-go/sqlserver2kafka/pkg/logging"
	"github.com/learn-go/sqlserver2kafka/pkg/setting"
	"github.com/learn-go/sqlserver2kafka/service"
	"go.uber.org/zap"
	"os"
)
...
func main() {
	...
	// 读取registry文件，
	_, err := os.Stat("./Exercise/day2/example/example1_2/registyr")
	if err != nil {
